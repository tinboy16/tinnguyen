...
## [#](https://docs.ar.io/gateways/ar-io-node/linux-setup.html#overview)Overview
...
## [#](https://docs.ar.io/gateways/ar-io-node/linux-setup.html#system-requirements)System Requirements
...
### [#](https://docs.ar.io/gateways/ar-io-node/linux-setup.html#minimum-requirements)Minimum requirements
...
### [#](https://docs.ar.io/gateways/ar-io-node/linux-setup.html#recommended)Recommended
...
## [#](https://docs.ar.io/gateways/ar-io-node/linux-setup.html#install-packages)Install Packages

If you would like to quickly install all required and suggested packages, you can run the following 2 commands in your terminal, and skip to  [installing the Node](https://docs.ar.io/gateways/ar-io-node/linux-setup.html#install-the-node).
...
### [#](https://docs.ar.io/gateways/ar-io-node/linux-setup.html#required-packages)Required packages
...
### [#](https://docs.ar.io/gateways/ar-io-node/linux-setup.html#suggested-packages)Suggested packages
...
## [#](https://docs.ar.io/gateways/ar-io-node/linux-setup.html#install-the-node)Install the Node
...
-   Create an environmental variables file:
    ...
    Advanced configuration options can be found at  [docs.ar.io(opens new window)](https://docs.ar.io/gateways/ar-io-node/advanced-config.html)
...
-   Supply Your Observer Wallet Keyfile:
    ...
    Learn more about creating Arweave wallets and obtaining keyfiles  [here(opens new window)](https://ar.io/wallet/)
...
## [#](https://docs.ar.io/gateways/ar-io-node/linux-setup.html#set-up-networking)Set up Networking

The following guide assumes you are running your node on a local home computer.

-   Register a Domain Name: Choose a domain registrar (e.g.,  [Namecheap (opens new window)](https://www.namecheap.com/)) to register a domain name.
...
-   Create SSL (HTTPS) Certificates for Your Domain:
    ...
    Follow the instructions to create the required TXT records for your domain in your chosen registrar. Use a  [DNS checker (opens new window)](https://dnschecker.org/)to verify the propagation of each record. This can take some time.
